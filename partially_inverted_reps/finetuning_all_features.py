...
try:
    ...
    from .finetuning import lightningmodule_callback
except:
...
def main(args=None):
    ...
    chopped_model = GraphExtractNet(copy.deepcopy(original_model), layer_names)
    ...
    if args.mode is not None:
        dirpath += f'frac-{args.fraction:.8f}-mode-{args.mode}-seed-{args.seed}-'
