...
#SBATCH --nodelist=sws-2a40grid-04            # node addr to request
...
#SBATCH -o /NS/llm-1/work/vnanda/llm_finetuning/pythia-410m/%x_%j.out      # File to which STDOUT will be written
#SBATCH -e /NS/llm-1/work/vnanda/llm_finetuning/pythia-410m/%x_%j.err      # File to which STDERR will be written
