...
--input-model /NS/llm-1/nobackup/vnanda/llm_base_models/pythia-1b \
--epochs 50 \
--local-output-dir /NS/llm-1/nobackup/vnanda/llm_finetuning/pythia-1b-finetuning \
--finetuning-ds databricks/databricks-dolly-15k \
--wandb-project-name pythia-1b-dolly-finetuning \
