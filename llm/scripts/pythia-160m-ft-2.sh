...
#SBATCH --nodelist=sws-2a40grid-03            # node addr to request
...
#SBATCH -o /NS/llm-1/work/vnanda/llm_finetuning/pythia-160m/%x_%j.out      # File to which STDOUT will be written
#SBATCH -e /NS/llm-1/work/vnanda/llm_finetuning/pythia-160m/%x_%j.err      # File to which STDERR will be written
...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
 ...
 --input-model /NS/llm-1/nobackup/vnanda/llm_base_models/pythia-160m \
 --epochs 50 \
 --local-output-dir /NS/llm-1/nobackup/vnanda/llm_finetuning/pythia-160m-finetuning \
 --finetuning-ds databricks/databricks-dolly-15k \
 --partial-dataset qa_only \
 --wandb-project-name pythia-160m-dolly-finetuning \
